...
namespace VectSharp.Markdown.CSharpMath.VectSharp
{
    internal class MathPainter : MathPainter<Page, Colour>
    {
        ...
        /// </summary>
        public static void DrawDisplay(MathPainter settings, global::CSharpMath.Display.IDisplay<Fonts, Glyph> display, Page canvas, PointF position)
        {
        ...
        /// Repositions the <paramref name="display"/>.
        /// </summary>
        public static void DrawDisplay(MathPainter settings, global::CSharpMath.Display.IDisplay<Fonts, Glyph> display,
        ...
        /// Repositions the <paramref name="display"/>.
        /// </summary>
        public static void DrawDisplay(MathPainter settings, global::CSharpMath.Display.IDisplay<Fonts, Glyph> display, Page canvas, float x, float y)
        {
        ...
        /// Repositions the <paramref name="display"/>.
        /// </summary>
        public static void DrawDisplay(MathPainter settings, global::CSharpMath.Display.IDisplay<Fonts, Glyph> display, Page canvas, TextAlignment textAlignment = TextAlignment.Center, Thickness padding = default, float offsetX = 0, float offsetY = 0)
        {
            DrawDisplay(settings, display, _ => _.Draw(canvas, textAlignment, padding, offsetX, offsetY));
        }

        private static void DrawDisplay(MathPainter settings, global::CSharpMath.Display.IDisplay<Fonts, Glyph> display, System.Action<MathPainter> draw)
        {
