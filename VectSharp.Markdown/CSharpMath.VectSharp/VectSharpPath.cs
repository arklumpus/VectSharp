...
{
    internal sealed class VectSharpPath : global::CSharpMath.Rendering.FrontEnd.Path
    {
        ...
        {
            if (_owner.CurrentStyle == global::CSharpMath.Rendering.FrontEnd.PaintStyle.Fill)
            {
